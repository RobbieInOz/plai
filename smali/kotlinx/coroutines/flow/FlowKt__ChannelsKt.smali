...
# direct methods
.method public static final a(Lhi/c;Lgi/n;ZLoh/c;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-direct {v0, p3}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt$emitAllImpl$1;-><init>(Loh/c;)V
    ...
    .line 5
    iget-object p3, p3, Lgi/g;->a:Ljava/lang/Object;
    :try_end_1
    ...
    invoke-interface {p1, v0}, Lgi/n;->n(Loh/c;)Ljava/lang/Object;
    ...
    :goto_2
    :try_start_3
    instance-of v2, p3, Lgi/g$a;

    if-eqz v2, :cond_a

    .line 10
    instance-of p2, p3, Lgi/g$a;

    const/4 v0, 0x0

    if-eqz p2, :cond_6

    check-cast p3, Lgi/g$a;
    ...
    iget-object p2, p3, Lgi/g$a;->a:Ljava/lang/Throwable;
    :try_end_3
    ...
    .line 11
    invoke-static {p1, v0}, Lmf/b;->h(Lgi/n;Ljava/lang/Throwable;)V
    ...
    .line 14
    :cond_a
    invoke-static {p3}, Lgi/g;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p2, p3, v0}, Lhi/c;->emit(Ljava/lang/Object;Loh/c;)Ljava/lang/Object;
    ...
    .line 16
    invoke-static {p1, p2}, Lmf/b;->h(Lgi/n;Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lhi/p;->o:Ljava/lang/Throwable;
