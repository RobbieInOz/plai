...
.field private sink:Lpi/d;

.field private socket:Ljava/net/Socket;

.field private source:Lpi/e;
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 10
    :try_start_1
    invoke-static {v1}, Lse/h;->t(Ljava/net/Socket;)Lpi/b0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;

    .line 11
    invoke-static {v1}, Lse/h;->p(Ljava/net/Socket;)Lpi/z;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lpi/d;
    :try_end_1
    ...
    invoke-static {p4, p3}, Lcom/android/billingclient/api/v;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 25
    invoke-static {p1, v2, v6}, Lkotlin/text/StringsKt__IndentKt;->w(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Luh/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Luh/a;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lpi/d;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 2
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;

    invoke-static {v0}, Lcom/android/billingclient/api/v;->d(Ljava/lang/Object;)V

    .line 3
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lpi/d;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lpi/e;Lpi/d;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Lpi/c0;->timeout(JLjava/util/concurrent/TimeUnit;)Lpi/c0;

    .line 6
    invoke-interface {v2}, Lpi/z;->timeout()Lpi/c0;
    ...
    invoke-static {v2, p3, v1}, Ldi/i;->B(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p3, p2}, Lcom/android/billingclient/api/v;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lpi/c;->b0()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lpi/d;->i()Lpi/c;
...
.method private final startHttp2(I)V
    ...
    .line 2
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lpi/e;Lpi/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 26
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;

    .line 27
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lpi/d;
...
.method public final isHealthy(Z)Z
    ...
    .line 6
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lpi/e;
    ...
    .line 12
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lpi/e;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 7
    invoke-interface {v1}, Lpi/b0;->timeout()Lpi/c0;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lpi/c0;->timeout(JLjava/util/concurrent/TimeUnit;)Lpi/c0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lpi/e;Lpi/d;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lpi/e;Lpi/d;Lokhttp3/internal/connection/Exchange;)V
