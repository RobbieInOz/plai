...
.method public constructor <init>(Lpi/e;Z)V
    .locals 7
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lpi/e;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lpi/b0;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {v1}, Lpi/e;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILpi/e;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {p4}, Lpi/e;->readInt()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;
    ...
    invoke-interface {v0, v1, v2}, Lpi/e;->y(J)Lokio/ByteString;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {p2}, Lpi/e;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {v3}, Lpi/e;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p3, p2, p4}, Ll/c;->a(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lpi/e;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lph/c;->w(II)Lai/c;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lph/c;->r(Lai/a;I)Lai/a;

    move-result-object p2

    .line 6
    iget v1, p2, Lai/a;->o:I

    .line 7
    iget v2, p2, Lai/a;->p:I

    .line 8
    iget p2, p2, Lai/a;->q:I
    ...
    .line 9
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {v4}, Lpi/e;->readShort()S
    ...
    .line 10
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lpi/e;

    invoke-interface {v5}, Lpi/e;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lpi/e;)I
    ...
    invoke-interface {p1, v0, v1}, Lpi/e;->h(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lpi/e;->y(J)Lokio/ByteString;
