...
.field private final hpackBuffer:Lpi/c;
...
.method public constructor <init>(Lpi/d;Z)V
    .locals 7
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpi/c;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLpi/c;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpi/c;

    invoke-interface {v0, v1, v2, v3}, Lpi/z;->write(Lpi/c;J)V
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lpi/d;->o0(Lokio/ByteString;)Lpi/d;
...
.method public final declared-synchronized data(ZILpi/c;I)V
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILpi/c;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILpi/c;I)V
    .locals 2
    ...
    invoke-interface {p1, p3, v0, v1}, Lpi/z;->write(Lpi/c;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lpi/d;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lpi/d;->d0(I)Lpi/d;
    ...
    invoke-interface {p2, p1}, Lpi/d;->O(I)Lpi/d;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lpi/d;->O(I)Lpi/d;
    ...
    invoke-interface {p1, p2}, Lpi/d;->O(I)Lpi/d;
    ...
    invoke-interface {p1, p3}, Lpi/d;->k0([B)Lpi/d;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpi/c;

    .line 4
    iget-wide v0, p3, Lpi/c;->p:J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpi/c;

    invoke-interface {p1, v4, v2, v3}, Lpi/z;->write(Lpi/c;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lpi/d;->O(I)Lpi/d;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 7
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lpi/d;->O(I)Lpi/d;

    .line 8
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpi/c;

    invoke-interface {p2, v2, v4, v5}, Lpi/z;->write(Lpi/c;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    invoke-interface {v4, v3}, Lpi/d;->J(I)Lpi/d;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lpi/d;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Lpi/d;->O(I)Lpi/d;
...
.method public final declared-synchronized windowUpdate(IJ)V
    ...
    invoke-static {p1, p2}, Lcom/android/billingclient/api/v;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
