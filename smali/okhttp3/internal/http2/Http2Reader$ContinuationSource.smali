...
.method public constructor <init>(Lpi/e;)V
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lpi/e;
...
.method private final readContinuationHeader()V
    ...
    .line 2
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lpi/e;

    invoke-static {v1}, Lokhttp3/internal/Util;->readMedium(Lpi/e;)I
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lpi/e;
    ...
    .line 7
    :cond_0
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lpi/e;

    invoke-interface {v2}, Lpi/e;->readInt()I
...
.method public read(Lpi/c;J)J
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lpi/e;

    iget v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->padding:I

    int-to-long v3, v3

    invoke-interface {v0, v3, v4}, Lpi/e;->h(J)V
    ...
    invoke-interface {v3, p1, p2, p3}, Lpi/b0;->read(Lpi/c;J)J
