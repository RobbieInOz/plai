...
.field public final z:Landroidx/appcompat/widget/a0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->z:Landroidx/appcompat/widget/a0;
    ...
    .line 16
    invoke-static {p2}, Lg3/e0$e;->d(Landroid/view/View;)I
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    .line 11
    iget-object v2, v2, Landroidx/appcompat/widget/z;->M:Landroid/widget/PopupWindow;

    invoke-static {v2, v3}, Landroidx/appcompat/widget/MenuPopupWindow$a;->b(Landroid/widget/PopupWindow;Landroid/transition/Transition;)V
    ...
    .line 16
    iget-object v4, p0, Landroidx/appcompat/view/menu/b;->w:Ljava/util/List;
    ...
    iput v4, p0, Landroidx/appcompat/view/menu/b;->E:I
    ...
    .line 18
    invoke-static {v4}, Lg3/e0$e;->d(Landroid/view/View;)I
    ...
    .line 21
    iget-object p2, p0, Landroidx/appcompat/view/menu/b;->L:Landroidx/appcompat/view/menu/i$a;
    ...
    .line 26
    :cond_8
    iput-object v3, p0, Landroidx/appcompat/view/menu/b;->M:Landroid/view/ViewTreeObserver;
...
.method public dismiss()V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/z;->c()Z
...
.method public e(Landroidx/appcompat/view/menu/l;)Z
    ...
    .line 4
    iget-object p1, p1, Landroidx/appcompat/widget/z;->q:Landroidx/appcompat/widget/v;
    ...
    .line 11
    :goto_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->L:Landroidx/appcompat/view/menu/i$a;
...
.method public k(Landroidx/appcompat/view/menu/i$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->L:Landroidx/appcompat/view/menu/i$a;
...
.method public onDismiss()V
    ...
    invoke-virtual {v4}, Landroidx/appcompat/widget/z;->c()Z
...
.method public final v(Landroidx/appcompat/view/menu/e;)V
    ...
    .line 1
    iget-object v2, v0, Landroidx/appcompat/view/menu/b;->p:Landroid/content/Context;
    ...
    .line 4
    iput-boolean v5, v3, Landroidx/appcompat/view/menu/d;->q:Z
    ...
    .line 6
    invoke-static/range {p1 .. p1}, Lf2/d;->u(Landroidx/appcompat/view/menu/e;)Z

    move-result v4

    .line 7
    iput-boolean v4, v3, Landroidx/appcompat/view/menu/d;->q:Z

    .line 8
    :cond_1
    :goto_0
    iget-object v4, v0, Landroidx/appcompat/view/menu/b;->p:Landroid/content/Context;

    iget v6, v0, Landroidx/appcompat/view/menu/b;->q:I

    const/4 v7, 0x0

    invoke-static {v3, v7, v4, v6}, Lf2/d;->m(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->p:Landroid/content/Context;
    ...
    .line 10
    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->z:Landroidx/appcompat/widget/a0;

    .line 11
    iput-object v8, v6, Landroidx/appcompat/widget/MenuPopupWindow;->Q:Landroidx/appcompat/widget/a0;

    .line 12
    iput-object v0, v6, Landroidx/appcompat/widget/z;->D:Landroid/widget/AdapterView$OnItemClickListener;

    .line 13
    iget-object v8, v6, Landroidx/appcompat/widget/z;->M:Landroid/widget/PopupWindow;

    invoke-virtual {v8, v0}, Landroid/widget/PopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 14
    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->C:Landroid/view/View;

    .line 15
    iput-object v8, v6, Landroidx/appcompat/widget/z;->C:Landroid/view/View;

    .line 16
    iget v8, v0, Landroidx/appcompat/view/menu/b;->B:I

    .line 17
    iput v8, v6, Landroidx/appcompat/widget/z;->z:I

    .line 18
    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/z;->s(Z)V
    ...
    .line 20
    invoke-virtual {v6, v3}, Landroidx/appcompat/widget/z;->p(Landroid/widget/ListAdapter;)V

    .line 21
    invoke-virtual {v6, v4}, Landroidx/appcompat/widget/z;->r(I)V

    .line 22
    iget v3, v0, Landroidx/appcompat/view/menu/b;->B:I

    .line 23
    iput v3, v6, Landroidx/appcompat/widget/z;->z:I

    .line 24
    iget-object v3, v0, Landroidx/appcompat/view/menu/b;->w:Ljava/util/List;
    ...
    .line 31
    iget-object v10, v10, Landroidx/appcompat/widget/z;->q:Landroidx/appcompat/widget/v;
    ...
    .line 44
    sget-object v9, Landroidx/appcompat/widget/MenuPopupWindow;->R:Ljava/lang/reflect/Method;

    if-eqz v9, :cond_d

    .line 45
    :try_start_0
    iget-object v10, v6, Landroidx/appcompat/widget/z;->M:Landroid/widget/PopupWindow;
    ...
    .line 47
    :cond_c
    iget-object v9, v6, Landroidx/appcompat/widget/z;->M:Landroid/widget/PopupWindow;

    invoke-static {v9, v8}, Landroidx/appcompat/widget/MenuPopupWindow$b;->a(Landroid/widget/PopupWindow;Z)V
    ...
    invoke-static {v9, v10}, Landroidx/appcompat/widget/MenuPopupWindow$a;->a(Landroid/widget/PopupWindow;Landroid/transition/Transition;)V

    .line 49
    iget-object v9, v0, Landroidx/appcompat/view/menu/b;->w:Ljava/util/List;
    ...
    .line 51
    iget-object v9, v9, Landroidx/appcompat/widget/z;->q:Landroidx/appcompat/widget/v;
    ...
    .line 54
    iget-object v12, v0, Landroidx/appcompat/view/menu/b;->D:Landroid/view/View;

    invoke-virtual {v12, v10}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 55
    iget v12, v0, Landroidx/appcompat/view/menu/b;->E:I
    ...
    .line 59
    :goto_b
    iput v9, v0, Landroidx/appcompat/view/menu/b;->E:I
    ...
    .line 61
    iput-object v7, v6, Landroidx/appcompat/widget/z;->C:Landroid/view/View;
    ...
    iget-object v14, v0, Landroidx/appcompat/view/menu/b;->C:Landroid/view/View;
    ...
    .line 69
    :goto_c
    iget v11, v0, Landroidx/appcompat/view/menu/b;->B:I
    ...
    .line 72
    :goto_f
    iput v13, v6, Landroidx/appcompat/widget/z;->t:I

    .line 73
    iput-boolean v5, v6, Landroidx/appcompat/widget/z;->y:Z

    .line 74
    iput-boolean v5, v6, Landroidx/appcompat/widget/z;->x:Z

    .line 75
    invoke-virtual {v6, v9}, Landroidx/appcompat/widget/z;->j(I)V
    ...
    .line 78
    iput v4, v6, Landroidx/appcompat/widget/z;->t:I
    ...
    .line 80
    iget v4, v0, Landroidx/appcompat/view/menu/b;->I:I

    invoke-virtual {v6, v4}, Landroidx/appcompat/widget/z;->j(I)V

    .line 81
    :cond_19
    iget-object v4, v0, Lf2/d;->o:Landroid/graphics/Rect;
    ...
    :goto_10
    iput-object v10, v6, Landroidx/appcompat/widget/z;->K:Landroid/graphics/Rect;
    ...
    .line 84
    iget-object v5, v0, Landroidx/appcompat/view/menu/b;->w:Ljava/util/List;

    invoke-interface {v5, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 85
    invoke-virtual {v6}, Landroidx/appcompat/widget/z;->a()V

    .line 86
    iget-object v4, v6, Landroidx/appcompat/widget/z;->q:Landroidx/appcompat/widget/v;
    ...
    .line 88
    iget-boolean v3, v0, Landroidx/appcompat/view/menu/b;->K:Z
