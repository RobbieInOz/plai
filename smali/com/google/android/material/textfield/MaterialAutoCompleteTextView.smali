...
# instance fields
.field public final s:Landroidx/appcompat/widget/z;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->u:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->t:Landroid/view/accessibility/AccessibilityManager;
    ...
    .line 11
    invoke-direct {v1, p1, v2, v3, v0}, Landroidx/appcompat/widget/z;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 12
    iput-object v1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->s:Landroidx/appcompat/widget/z;

    const/4 p1, 0x1

    .line 13
    invoke-virtual {v1, p1}, Landroidx/appcompat/widget/z;->s(Z)V

    .line 14
    iput-object p0, v1, Landroidx/appcompat/widget/z;->C:Landroid/view/View;
    ...
    invoke-virtual {v1, p1}, Landroidx/appcompat/widget/z;->p(Landroid/widget/ListAdapter;)V

    .line 17
    new-instance p1, Lcom/google/android/material/textfield/o;

    invoke-direct {p1, p0}, Lcom/google/android/material/textfield/o;-><init>(Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;)V

    .line 18
    iput-object p1, v1, Landroidx/appcompat/widget/z;->D:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public onMeasure(II)V
    ...
    .line 8
    iget-object v5, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->s:Landroidx/appcompat/widget/z;

    .line 9
    invoke-virtual {v5}, Landroidx/appcompat/widget/z;->c()Z
    ...
    .line 10
    :cond_1
    iget-object v5, v5, Landroidx/appcompat/widget/z;->q:Landroidx/appcompat/widget/v;
    ...
    .line 20
    :cond_4
    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->s:Landroidx/appcompat/widget/z;

    invoke-virtual {v0}, Landroidx/appcompat/widget/z;->f()Landroid/graphics/drawable/Drawable;
    ...
    .line 21
    iget-object v2, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->u:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    .line 22
    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->u:Landroid/graphics/Rect;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 2
    iget-object p1, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->s:Landroidx/appcompat/widget/z;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/z;->p(Landroid/widget/ListAdapter;)V
...
.method public showDropDown()V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;->t:Landroid/view/accessibility/AccessibilityManager;
