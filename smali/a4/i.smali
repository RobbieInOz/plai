...
.field public final t:Le4/b;

.field public u:Landroidx/room/a;

.field public v:Z


# virtual methods
.method public declared-synchronized X0()Le4/a;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, v0}, La4/i;->b(Z)V

    .line 3
    iput-boolean v0, p0, La4/i;->v:Z

    .line 4
    :cond_0
    iget-object v0, p0, La4/i;->t:Le4/b;
...
.method public final a(Ljava/io/File;Z)V
    ...
    .line 1
    iget-object p2, p0, La4/i;->p:Ljava/lang/String;

    if-eqz p2, :cond_0

    .line 2
    iget-object p2, p0, La4/i;->o:Landroid/content/Context;

    invoke-virtual {p2}, Landroid/content/Context;->getAssets()Landroid/content/res/AssetManager;

    move-result-object p2

    iget-object v0, p0, La4/i;->p:Ljava/lang/String;
    ...
    .line 3
    :cond_0
    iget-object p2, p0, La4/i;->q:Ljava/io/File;
    ...
    iget-object v0, p0, La4/i;->q:Ljava/io/File;
    ...
    .line 5
    :cond_1
    iget-object p2, p0, La4/i;->r:Ljava/util/concurrent/Callable;
    ...
    .line 8
    :goto_0
    iget-object v0, p0, La4/i;->o:Landroid/content/Context;
...
.method public final b(Z)V
    ...
    .line 1
    invoke-virtual {p0}, La4/i;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    .line 2
    iget-object v2, p0, La4/i;->o:Landroid/content/Context;
    ...
    .line 3
    iget-object v3, p0, La4/i;->u:Landroidx/room/a;

    if-eqz v3, :cond_1

    iget-boolean v3, v3, Landroidx/room/a;->l:Z
    ...
    iget-object v5, p0, La4/i;->o:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->getFilesDir()Ljava/io/File;

    move-result-object v5

    invoke-direct {v4, v1, v5, v3}, Lc4/a;-><init>(Ljava/lang/String;Ljava/io/File;Z)V

    .line 5
    :try_start_0
    iget-object v3, v4, Lc4/a;->b:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v3}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 6
    iget-boolean v3, v4, Lc4/a;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, v4, Lc4/a;->a:Ljava/io/File;
    ...
    iput-object v3, v4, Lc4/a;->d:Ljava/nio/channels/FileChannel;
    ...
    .line 11
    :try_start_3
    invoke-virtual {p0, v2, p1}, La4/i;->a(Ljava/io/File;Z)V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_1
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 12
    invoke-virtual {v4}, Lc4/a;->a()V
    ...
    :cond_4
    :try_start_5
    invoke-static {v2}, Lc4/c;->c(Ljava/io/File;)I
    ...
    :cond_5
    :try_start_7
    iget-object v7, p0, La4/i;->u:Landroidx/room/a;
    ...
    :cond_6
    :try_start_8
    iget-object v3, p0, La4/i;->o:Landroid/content/Context;
...
.method public declared-synchronized close()V
    ...
    invoke-interface {v0}, Le4/b;->close()V
