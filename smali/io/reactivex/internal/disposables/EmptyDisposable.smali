...
.field public static final synthetic o:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method public static constructor <clinit>()V
    ...
    .line 3
    sput-object v3, Lio/reactivex/internal/disposables/EmptyDisposable;->o:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method public static complete(Lqg/b;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lqg/b;->onSubscribe(Ltg/b;)V

    .line 6
    invoke-interface {p0}, Lqg/b;->onComplete()V

    return-void
.end method

.method public static complete(Lqg/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lqg/h;->onSubscribe(Ltg/b;)V

    .line 4
    invoke-interface {p0}, Lqg/h;->onComplete()V

    return-void
.end method

.method public static complete(Lqg/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lqg/l;->onSubscribe(Ltg/b;)V

    .line 2
    invoke-interface {p0}, Lqg/l;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lqg/b;)V
    .locals 1

    .line 3
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p1, v0}, Lqg/b;->onSubscribe(Ltg/b;)V

    .line 4
    invoke-interface {p1, p0}, Lqg/b;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lqg/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lqg/h;->onSubscribe(Ltg/b;)V

    .line 8
    invoke-interface {p1, p0}, Lqg/h;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lqg/l;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lqg/o;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lqg/o;->onSubscribe(Ltg/b;)V

    .line 6
    invoke-interface {p1, p0}, Lqg/o;->onError(Ljava/lang/Throwable;)V
...
.method public static values()[Lio/reactivex/internal/disposables/EmptyDisposable;
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->o:[Lio/reactivex/internal/disposables/EmptyDisposable;
