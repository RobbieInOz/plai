...
.field public final downstream:Lxg/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxg/a<",
            "-TT;>;"
...
# direct methods
.method public constructor <init>(Lxg/a;Lqg/m$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lqg/m$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lxg/a;
...
.method public onSubscribe(Laj/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Laj/c;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Laj/c;
    ...
    .line 5
    invoke-interface {v0, v1}, Lxg/c;->requestFusion(I)I
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lxg/g;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lxg/a;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lxg/a;

    invoke-interface {v0, p0}, Lqg/f;->onSubscribe(Laj/c;)V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lxg/g;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Laj/c;

    invoke-interface {v3, v1, v2}, Laj/c;->request(J)V
...
.method public runAsync()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lxg/g;
    ...
    .line 7
    :try_start_0
    invoke-interface {v1}, Lxg/g;->poll()Ljava/lang/Object;
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLaj/b;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v12}, Lxg/a;->b(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Laj/c;

    invoke-interface {v10, v4, v5}, Laj/c;->request(J)V
    ...
    .line 12
    invoke-static {v2}, Lse/h;->u(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3}, Laj/c;->cancel()V

    .line 15
    invoke-interface {v1}, Lxg/g;->clear()V

    .line 16
    invoke-interface {v0, v2}, Laj/b;->onError(Ljava/lang/Throwable;)V

    .line 17
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lqg/m$c;
    ...
    invoke-interface {v1}, Lxg/g;->isEmpty()Z

    move-result v9

    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLaj/b;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lxg/a;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Laj/b;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lxg/a;

    invoke-interface {v1, v0}, Laj/b;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    .line 10
    :cond_3
    invoke-interface {v0, v8}, Lxg/a;->b(Ljava/lang/Object;)Z
    ...
    .line 11
    invoke-static {v1}, Lse/h;->u(Ljava/lang/Throwable;)V

    .line 12
    iput-boolean v4, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->cancelled:Z

    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Laj/c;

    invoke-interface {v2}, Laj/c;->cancel()V
