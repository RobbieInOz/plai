...
.field public static final synthetic o:[Lio/reactivex/internal/subscriptions/SubscriptionHelper;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v1, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->o:[Lio/reactivex/internal/subscriptions/SubscriptionHelper;
...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 4
    invoke-interface {p0}, Laj/c;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Laj/c;->request(J)V
    ...
    .line 4
    invoke-static {p1, p2, p3}, Lx8/s4;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .line 7
    invoke-interface {p0, v0, v1}, Laj/c;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Laj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Laj/c;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static reportMoreProduced(J)V
    ...
    invoke-static {v1, p0, p1}, Ll/d;->a(Ljava/lang/String;J)Ljava/lang/String;
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Laj/c;)Z
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Laj/c;->request(J)V
...
.method public static validate(Laj/c;Laj/c;)Z
    .locals 1
    ...
    invoke-static {p0}, Lgh/a;->c(Ljava/lang/Throwable;)V
...
.method public static values()[Lio/reactivex/internal/subscriptions/SubscriptionHelper;
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->o:[Lio/reactivex/internal/subscriptions/SubscriptionHelper;
