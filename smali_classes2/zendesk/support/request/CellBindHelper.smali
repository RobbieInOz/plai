...
.method private openAttachment(Landroid/content/Context;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    .line 1
    invoke-static {p1}, Lik/a;->a(Landroid/content/Context;)Lik/a;
    ...
    .line 6
    invoke-virtual {v2, v1, p2}, Landroid/content/Intent;->setDataAndType(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v1, p2}, Lik/p;->a(Ljava/lang/String;Ljava/lang/String;)V

    .line 8
    iget-object p2, v0, Lik/a;->b:Lik/s;
    ...
    .line 11
    invoke-virtual {p2, v2, v4}, Landroid/content/pm/PackageManager;->queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
...
.method public bindStatusLabel(Landroid/widget/TextView;ZZ)V
    ...
    .line 2
    invoke-static {p3, v0}, Lu2/a$d;->a(Landroid/content/Context;I)I
    ...
    .line 9
    invoke-static {p3, p3, v2, v0}, Li3/a;->b(FFFF)Landroid/view/animation/PathInterpolator;
