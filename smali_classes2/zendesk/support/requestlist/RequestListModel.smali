...
.field private final mapper:Ljf/a;
...
.method public constructor <init>(Lzendesk/support/requestlist/RequestInfoDataSource;Lzendesk/core/MemoryCache;Lzendesk/support/SupportBlipsProvider;Lzendesk/support/SupportSettingsProvider;)V
    ...
    iput-object v0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:Ljf/a;
...
.method public static synthetic access$100(Lzendesk/support/requestlist/RequestListModel;)Ljf/a;
    .locals 0

    .line 1
    iget-object p0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:Ljf/a;
...
.method private filterClosedRequests(Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-static {p1, p2}, Lmf/a;->e(Ljava/util/Collection;Ljf/a;)Ljava/util/List;
...
.method public loadItems(ZLzendesk/support/SupportSdkSettings;Llf/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-direct {v0, p0, p2, p3}, Lzendesk/support/requestlist/RequestListModel$1;-><init>(Lzendesk/support/requestlist/RequestListModel;Lzendesk/support/SupportSdkSettings;Llf/d;)V

    invoke-interface {p1, v0}, Lzendesk/support/requestlist/RequestInfoDataSource;->load(Llf/d;)V

    :goto_1
    return-void
.end method

.method public loadSettings(Llf/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lzendesk/support/AggregatedCallback;->add(Llf/d;)Z
    ...
    invoke-interface {p1, v0}, Lzendesk/support/SupportSettingsProvider;->getSettings(Llf/d;)V
