          ...
          (t.Diff = function (e, t) {
            ...
            (t.prototype.diff_compute_ = function (e, r, i, o) {
              ...
              if (-1 != d)
                return (
                  (a = [
                    new t.Diff(1, l.substring(0, d)),
                    new t.Diff(0, s),
                    new t.Diff(1, l.substring(d + s.length)),
                  ]),
            ...
            (t.prototype.diff_halfMatch_ = function (e, t) {
              ...
              return u || p
                ? ((a = p ? (u && u[4].length > p[4].length ? u : p) : u),
                  e.length > t.length
                    ? ((l = a[0]), (s = a[1]), (d = a[2]), (c = a[3]))
                    : ((d = a[0]), (c = a[1]), (l = a[2]), (s = a[3])),
                  [l, s, d, c, a[4]])
                : null;
            }),
            ...
            (t.prototype.diff_cleanupEfficiency = function (e) {
              for (
                ...
                0 == e[l][0]
                  ? (e[l][1].length < this.Diff_EditCost && (c || u)
                      ? ((i[o++] = l), (s = c), (d = u), (a = e[l][1]))
                      : ((o = 0), (a = null)),
                    (c = u = !1))
                  : (e[l][0] == n ? (u = !0) : (c = !0),
                    a &&
              ...
              for (
                ...
                switch ((d || 0 === v || ((s.start1 = c), (s.start2 = u)), v)) {
                  case 1:
                    (s.diffs[d++] = a[f]),
                      (s.length2 += h.length),
                      (m = m.substring(0, u) + h + m.substring(u));
                    break;
                  case n:
                    (s.length1 += h.length),
                      (s.diffs[d++] = a[f]),
                      (m = m.substring(0, u) + m.substring(u + h.length));
                    break;
                  case 0:
                  ...
                  if (
                    ...
                    for (var m, f = 0, v = 0; v < e[a].diffs.length; v++) {
                      ...
                      0 !== h[0] && (m = this.diff_xIndex(p, f)),
                        1 === h[0]
                          ? (t =
                              t.substring(0, l + m) + h[1] + t.substring(l + m))
                          : h[0] === n &&
                            (t =
                              t.substring(0, l + m) +
                              t.substring(
                                l + this.diff_xIndex(p, f + h[1].length)
                              )),
                        h[0] !== n && (f += h[1].length);
                    }
                  }
                  ...
                  for (
                    ...
                    for (
                      d.start1 = a - s.length,
                        d.start2 = l - s.length,
                        "" !== s &&
                          ((d.length1 = d.length2 = s.length),
                          d.diffs.push(new t.Diff(0, s)));
                      ...
                      1 === u
                        ...
                        : ((p = p.substring(
                            0,
                            r - d.length1 - this.Patch_Margin
                          )),
                          (d.length1 += p.length),
                          (a += p.length),
                          0 === u
                            ? ((d.length2 += p.length), (l += p.length))
                            : (c = !1),
                          d.diffs.push(new t.Diff(u, p)),
                          p == o.diffs[0][1]
                            ? o.diffs.shift()
                    ...
                    s = (s = this.diff_text2(d.diffs)).substring(
                    ...
                    "" !== m &&
                      ...
                      (d.length2 += m.length),
                      0 !== d.diffs.length &&
                      0 === d.diffs[d.diffs.length - 1][0]
                        ? (d.diffs[d.diffs.length - 1][1] += m)
                        : d.diffs.push(new t.Diff(0, m))),
                      c || e.splice(++i, 0, d);
                  }
                }
            }),
          ...
          var r = n(478),
                    ...
                    if ("vditor-speech" === i.className) {
                      ...
                      speechSynthesis.speaking &&
                        (speechSynthesis.paused
                          ? (speechSynthesis.resume(), (i.innerHTML = r))
                          : (speechSynthesis.pause(), (i.innerHTML = n)));
            ...
            A = function (e) {
              var t = {
                ...
                customEmoji: {},
                emojiPath:
                  ((e && e.emojiPath) || y.g.CDN) + "/dist/images/emoji",
          ...
          var r = "3.9.6",
            i = (function () {
              ...
              return (
                ...
                (e.CDN = "https://unpkg.com/vditor@3.9.6"),
                (e.MARKDOWN_OPTIONS = {
                  autoSpace: !1,
                  gfmAutoLink: !0,
                  codeBlockPreview: !0,
                ...
                if (
                  ...
                  (u.className = "vditor-copy"),
                    (u.innerHTML =
                      ...
                      ((null === (l = window.VditorI18n) || void 0 === l
                        ? void 0
                        : l.copied) || "已复制") +
                      "')\">" +
                      c +
                  ...
                  (p.value = (0, r.X)(s)),
                    ...
                    t.insertAdjacentHTML(
                      "afterend",
                      '<span style="position: absolute">' + i.g.ZWSP + "</span>"
                    );
                }
              });
            };
        ...
        66: (e, t, n) => {
          ...
          var r = n(54),
            ...
            a = function (e, t) {
              ...
              0 !== n.length &&
                (0, i.G)(
                  t + "/dist/js/flowchart.js/flowchart.min.js",
            ...
            a = function (e, t, n) {
              ...
              !1 !== e.enable) &&
                ...
                (0, i.G)(
                  ...
                  (0, i.G)(
                    n + "/dist/js/highlight.js/solidity.min.js",
                    "vditorHljsSolidityScript"
                  ).then(function () {
                    (0, i.G)(
                      n + "/dist/js/highlight.js/yul.min.js",
                      "vditorHljsYulScript"
                    ).then(function () {
        ...
        563: (e, t, n) => {
          ...
          var r = n(54),
            ...
            s = function (e, t, n) {
              ...
              0 !== a.length &&
                (0, i.G)(
                  t + "/dist/js/markmap/markmap.min.js",
                  "vditorMermaidScript"
                ).then(function () {
                  a.forEach(function (e) {
                ...
                if (
                  ...
                  (0, o.c)(
                    ...
                    (0, i.G)(
                      ...
                      (0, i.G)(
                        t.cdn + "/dist/js/katex/mhchem.min.js",
                  ...
                  window.MathJax ||
                    ((window.MathJax = {
                      loader: {
                        paths: { mathjax: t.cdn + "/dist/js/mathjax" },
                      },
                      startup: { typeset: !1 },
                    ...
                    (0, i.J)(
                      t.cdn + "/dist/js/mathjax/tex-svg-full.js",
        ...
        40: (e, t, n) => {
          ...
          var r = n(54),
            ...
            a = function (e, t, n) {
              ...
              0 !== a.length &&
                (0, i.G)(
                  t + "/dist/js/mermaid/mermaid.min.js",
                  "vditorMermaidScript"
                ).then(function () {
                  var e = {
                    securityLevel: "loose",
        ...
        818: (e, t, n) => {
          ...
          var r = n(64),
            ...
            o = function (e, t, n) {
              ...
              var d = l.firstElementChild.querySelectorAll(
        ...
        408: (e, t, n) => {
          ...
          var r = n(54),
            ...
            a = function (e, t) {
              ...
              0 !== n.length &&
                (0, i.G)(
                  t + "/dist/js/plantuml/plantuml-encoder.min.js",
        ...
        863: (e, t, n) => {
          ...
          var r = function (e, t, n) {
            ...
            setTimeout(function () {
              i.setAttribute(
                "style",
                "transition: transform .3s ease-in-out;transform: " + o
              ),
                setTimeout(function () {
        ...
        312: (e, t, n) => {
          ...
          var r = n(54),
            ...
            o = function (e, t) {
              ...
              n
                ? n.href !== o && (n.remove(), (0, i.c)(o, "vditorHljsStyle"))
        ...
        var e,
          ...
          R = function (e, t, n, r) {
            ...
            if (o && !n && "code-block" !== o.getAttribute("data-type")) {
              if (
                (lt(o.innerHTML) && o.previousElementSibling) ||
                st(o.innerHTML)
              )
                return;
              for (
                var l = (0, D.im)(o, e.ir.element, t).start, s = !0, d = l - 1;
                d > o.textContent.substr(0, l).lastIndexOf("\n");
                d--
              )
                if (
            ...
            if (f) h = o.innerHTML;
              ...
              if (
                ...
                !k ||
                  ...
                  ((h = k.outerHTML + h), k.remove()),
                  !S ||
                    ("UL" !== S.tagName && "OL" !== S.tagName) ||
                    ((h += S.outerHTML), S.remove()),
                  (h = h.replace(
                    "<div><wbr><br></div>",
                    "<li><p><wbr><br></p></li>"
                  ));
                ...
                o.previousElementSibling &&
                  ...
                  ((h = o.previousElementSibling.outerHTML + h),
            ...
            var A,
              _ = e.ir.element.querySelectorAll(
            ...
            var x = e.ir.element.querySelectorAll(
          ...
          P = function (e, t) {
            ...
            if (
              ...
              return !((0, d.yl)(t) || t.altKey || t.shiftKey || t.code !== e);
            if ("⇧Tab" === e)
              return !(
                (0, d.yl)(t) ||
                t.altKey ||
            ...
            return (
              !i ||
                (!(0, d.vU)() && /Mac/.test(navigator.platform)) ||
                ("-" === o ? (o = "_") : "=" === o && (o = "+")),
              !(
                !(0, d.yl)(t) ||
          ...
          V = function (e, t) {
            ...
            if (
              ...
              for (
                var a = (0, D.im)(o, e.sv.element, r).start, l = !0, s = a - 1;
                ...
                if (d) {
                  ...
                  if ("code-block-close-marker" === d.getAttribute("data-type"))
                    if ((c = Ne(i, "code-block-open-marker")))
                      return (c.textContent = d.textContent), void Ie(e);
            ...
            if (o && "$$" === o.textContent.trimRight()) Ie(e);
              ...
              h
                ? (v = o.textContent)
                : (o.previousElementSibling &&
                    ((v = o.previousElementSibling.textContent + v),
                    o.previousElementSibling.remove()),
                  o.previousElementSibling &&
                    0 === v.indexOf("---\n") &&
                    ((v = o.previousElementSibling.textContent + v),
              ...
              var g,
                b = e.sv.element.querySelectorAll(
                  "[data-type='link-ref-defs-block']"
                );
              b.forEach(function (e, t) {
                ...
                b.length > 0 &&
                  e.sv.element.insertAdjacentElement("beforeend", f);
              var w = e.sv.element.querySelectorAll(
              ...
              w.forEach(function (e, t) {
                ...
                w.length > 0 &&
                  e.sv.element.insertAdjacentElement("beforeend", g),
        ...
        var F,
              ...
              (e.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function () {
                if (
                  ...
                  if (a) {
                    ...
                    if (
                      l.length > 1 &&
                      a.nextSibling.isSameNode(a.nextElementSibling)
                    ) {
                  ...
                  if (
                    ...
                    var E = function () {
                        ...
                        at(v, n),
                          "right" === n
                            ? (T.classList.remove("vditor-icon--current"),
                              C.classList.remove("vditor-icon--current"),
                      ...
                      M = "left";
                    S
                      ? (M = S.getAttribute("align") || "left")
                      : L && (M = L.getAttribute("align") || "center");
                    ...
                    Z.appendChild(R),
                      ...
                      (R.onkeydown = function (n) {
                        if (!n.isComposing)
                          return "Tab" === n.key
                            ? (q.focus(), q.select(), void n.preventDefault())
                            : void (ie(e, n) || me(n, t));
                      });
                  ...
                  if (
                    ...
                    if (
                      ...
                      (K.className = "vditor-input"),
                        ...
                        (K.value =
                          F.className.indexOf("language-") > -1
                            ? F.className.split("-")[1].split(" ")[0]
                            : ""),
                        (K.oninput = function (n) {
                          "" !== K.value.trim()
                            ? (F.className = "language-" + K.value)
                            : ((F.className = ""),
          ...
          de = function (e, t, n) {
            ...
            if (
              ...
              i.setAttribute("type", "button"),
                ...
                i.setAttribute(
                  "aria-label",
                  window.VditorI18n.down + "<" + (0, d.ns)("⇧⌘D") + ">"
                ),
                (i.innerHTML =
          ...
          ce = function (e, t) {
            ...
            n.setAttribute("type", "button"),
              ...
              n.setAttribute(
                "aria-label",
                window.VditorI18n.remove + "<" + (0, d.ns)("⇧⌘X") + ">"
              ),
              (n.innerHTML =
          ...
          me = function (e, t) {
            if (
              (!(0, d.yl)(e) && !e.shiftKey && "Enter" === e.key) ||
              "Escape" === e.key
            )
              return (
                t && (0, D.Hc)(t), e.preventDefault(), e.stopPropagation(), !0
              );
          },
          fe = function (e) {
            "wysiwyg" === e.currentMode
              ? oe(e)
              : "ir" === e.currentMode && X(e);
          },
          ve = function (e, t, n) {
            void 0 === n &&
          ...
          be = function (e, t, n) {
            ...
            if (
              ("string" != typeof n
                ? (h(e, ["subToolbar", "hint"]), n.preventDefault(), (r = a(e)))
                : (r = n),
                    ...
                    (function (e, t) {
                      ...
                      if (
                        (!u &&
                          ...
                          "blockquote-marker" ===
                            c.previousElementSibling.getAttribute(
                              "data-type"
                            ) &&
                      ...
                      if (
                        ...
                        if (
                          w &&
                          0 === (0, D.im)(w, e.sv.element, l).start &&
                          w.previousElementSibling
                        ) {
                          l.extractContents();
                          var M = w.previousElementSibling.lastElementChild;
                          return (
                            "newline" === M.getAttribute("data-type") &&
                              (M.remove(),
                              (M = w.previousElementSibling.lastElementChild)),
                            "newline" !== M.getAttribute("data-type") &&
                              (M.insertAdjacentHTML("afterend", w.innerHTML),
                              w.remove()),
                            "" === w.textContent.trim() ||
                            ...
                            void 0 === a
                              ...
                              ? ("newline" !== M.getAttribute("data-type") &&
                                  (l.selectNodeContents(M.lastChild),
                                  l.collapse(!1)),
                                Ie(e))
                              : V(e),
                            t.preventDefault(),
                  ...
                  if (
                    (function (e, t) {
                      ...
                      if (l) {
                        ...
                        if ("0" === l.getAttribute("data-block")) {
                          ...
                          if (
                            ...
                            nt(e, t, n, l.firstElementChild, l)
                          )
                            return !0;
                        }
                      }
                      ...
                      if (c && !t.shiftKey && t.altKey && "Enter" === t.key) {
                        (0, d.yl)(t) ? n.setStartBefore(c) : n.setStartAfter(c),
                          (0, D.Hc)(n);
                      ...
                      if (m) {
                        ...
                        if (P("⌘=", t))
                          return (
                            (v = parseInt(m.tagName.substr(1), 10) - 1) > 0 &&
                              (te(e, "h" + v), Y(e)),
                            t.preventDefault(),
                            !0
                          );
                        if (P("⌘-", t))
                          return (
                            (v = parseInt(m.tagName.substr(1), 10) + 1) < 7 &&
                              (te(e, "h" + v), Y(e)),
                            t.preventDefault(),
                            !0
                          );
          ...
          He = function (e, t) {
            ...
            (i =
              i.indexOf('data-type="footnotes-link"') > -1 ||
          ...
          De = function (e, t) {
            ...
            return (
              (e =
                n.indexOf('data-type="footnotes-link"') > -1 ||
          ...
          Re = function (e, t, n, r) {
            ...
            if (a) {
              ...
              if (
                ...
                return (
                  c
                    ? c.insertAdjacentText("afterend", d)
                    : a.insertAdjacentText("afterbegin", d),
                  void V(e)
                );
              }
                        ...
                        if (h.readyState === XMLHttpRequest.DONE) {
                          if (
                            ...
                            if (e.options.upload.success)
                              e.options.upload.success(l, h.responseText);
                            else {
                            ...
                            e.options.upload.error
                              ? e.options.upload.error(h.responseText)
                              : e.tip.show(h.responseText);
                          n && (n.value = ""),
          ...
          ze = function (e, t, n) {
            ...
            if (
              ...
              if (
                ...
                if (v) {
                  var h = e.wysiwyg.element.querySelector(
                    'sup[data-type="footnotes-ref"][data-footnotes-label="' +
                      v.getAttribute("data-marker") +
                      '"]'
                  );
                  h &&
                    h.setAttribute(
                      "aria-label",
                      v.textContent.trim().substr(0, 24)
                    );
                }
              }
              var g,
            ...
            O(e),
              Y(e, { enableAddUndoStack: !0, enableHint: !0, enableInput: !0 });
          },
          Ge = function (e, t) {
            return (
          ...
          rt = function (e, t, n, r) {
            ...
            if (
              ...
              d ||
                ...
                ((d = e[e.currentMode].element.querySelector("p")).innerHTML =
                  "<wbr>")),
                "check" === n
                  ...
                  ? (d.insertAdjacentHTML(
                      "beforebegin",
                      '<ul data-block="0"><li>' + d.innerHTML + "</li></ul>"
                    ),
                    d.remove())
                  : "ordered-list" === n &&
                    (d.insertAdjacentHTML(
                      "beforebegin",
                      '<ol data-block="0"><li>' + d.innerHTML + "</li></ol>"
                    ),
                    d.remove());
            }
          },
            ...
            if (l) {
                ...
                return (
                  l.nextElementSibling
                    ? (l.parentElement.insertAdjacentHTML(
                        "beforebegin",
                        '<p data-block="0"><wbr>' + l.innerHTML + "</p>"
                      ),
                      l.remove())
              ...
              if (!(0, d.yl)(r) && !r.altKey && "Tab" === r.key) {
                ...
                if (
                  ...
                  return (
                    r.shiftKey ? ot(t, l, e, l.parentElement) : it(t, l, e),
                    r.preventDefault(),
                    !0
                  );
              }
                ...
                if (lt(n.innerHTML) && n.previousElementSibling) {
                  ...
                  return (
                    ...
                    n.insertAdjacentHTML(
                      "afterend",
                      l + '<hr data-block="0"><p data-block="0"><wbr>\n</p>'
                    ),
                    n.remove(),
                    (0, D.ib)(t[t.currentMode].element, r),
                    dt(t),
          ...
          yt = function (e, t, n) {
            ...
            if (i) {
              ...
              if ("ArrowUp" === t.key) {
                ...
                return (
                  c || (c = s.parentElement.previousElementSibling.firstChild),
              ...
              if (P("⇧⌘R", t)) {
                if ("ir" === e.currentMode)
                  return at(a, "right"), dt(e), t.preventDefault(), !0;
                var m;
                if (
          ...
          kt = function (e, t, n, r) {
            ...
            if (r) {
              ...
              if (
                ...
                (((0, d.vU)() && "HR" === o.tagName) || "TABLE" === o.tagName)
              ) {
                if ("TABLE" === o.tagName) {
                ...
                switch (E.label) {
                  ...
                  case 5:
                    (v = new FileReader()),
                      "clipboardData" in t
                        ...
                        : t.dataTransfer.types.includes("Files") &&
                          ((a = t.dataTransfer.items), (h = a[0].getAsFile())),
                      h &&
                    ...
                    "" !== o.trim() &&
                      ...
                      "ir" === e.currentMode
                        ? ((l.Md2VditorIRDOM = { renderLinkDest: s }),
                          e.lute.SetJSRenderers({ renderers: l }),
                          (0, D.oC)(e.lute.Md2VditorIRDOM(o), e))
                        : "wysiwyg" === e.currentMode
                        ? ((l.Md2VditorDOM = { renderLinkDest: s }),
                          e.lute.SetJSRenderers({ renderers: l }),
                          (0, D.oC)(e.lute.Md2VditorDOM(o), e))
                        : ((l.Md2VditorSVDOM = { renderLinkDest: s }),
                          e.lute.SetJSRenderers({ renderers: l }),
                          He(e, o)),
                      e.outline.render(e)),
                  ...
                  case 8:
                    return (
                      ...
                      e.wysiwyg.triggerRemoveComment(e),
                      dt(e),
                      e[e.currentMode].element.scrollHeight - c >
                        Math.min(
            ...
            if (n)
              if (
                ...
                (n.textContent = i.g.ZWSP + e.hint.recentLanguage),
                  (0, D.zh)(e).selectNodeContents(n);
              } else {
                var r = [],
                  o = n.textContent
                    .substring(0, (0, D.im)(n, e.ir.element).start)
                    .replace(i.g.ZWSP, "");
            ...
            if (t.classList.contains("vditor-menu--current"))
              if ("quote" === o) {
                ...
                if (d) {
                  ...
                  u
                    ? (i.insertNode(document.createElement("wbr")),
                      (d.outerHTML = u.innerHTML))
                    : (d.outerHTML =
                        d.querySelector(".vditor-ir__link").innerHTML +
                        "<wbr>");
                }
              } else
                "italic" === o
                  ...
                  (this.element.style.top = l + (d || 22) + "px"),
                    ...
                    this.element.getBoundingClientRect().bottom >
                      ...
                      (this.element.style.top =
                        l - this.element.offsetHeight + "px"),
              ...
              return (
                Object.keys(t.options.preview.theme.list).forEach(function (e) {
                  a +=
                    ...
                    e +
                    '">' +
                    t.options.preview.theme.list[e] +
                    "</button>";
                }),
                (o.innerHTML =
                  '<div style="overflow: auto;max-height:' +
                      ...
                      e.element.className.includes("vditor--fullscreen")
                        ? (t.level || (this.innerHTML = t.icon),
                          ...
                          Object.keys(e.toolbar.elements).forEach(function (t) {
                            ...
                            n &&
                              (n.className = n.className.replace("__s", "__n"));
                          }),
                          e.counter &&
                      ...
                      r.preventDefault(),
                        "wysiwyg" === e.currentMode
                          ? (te(e, r.target.getAttribute("data-tag")),
                            ...
                            n.classList.add("vditor-menu--current"))
                          : "ir" === e.currentMode
                          ? (At(e, r.target.getAttribute("data-value")),
                            n.classList.add("vditor-menu--current"))
            ...
            return (
              ...
              (e.prototype.downSampleBuffer = function (e, t) {
                ...
                for (
                  ...
                  for (
                    var l = Math.round((o + 1) * n), s = 0, d = 0, c = a;
                    c < l && c < e.length;
                    c++
                  )
                    (s += e[c]), d++;
                    ...
                    if (
                      ...
                      if (t)
                        ...
                        navigator.mediaDevices
                          ...
                          .then(function (r) {
                            ((t = new Hn(r)).recorder.onaudioprocess =
                              function (e) {
                                if (t.isRecording) {
            ...
            function t(t, n) {
              ...
              return (
                ...
                t.options.upload.accept &&
                  (i += ' accept="' + t.options.upload.accept + '"'),
            ...
            return (
              ...
              (e.prototype.renderDiff = function (e, t, n) {
                ...
                O(t),
                  ...
                  t[t.currentMode].element
                    .querySelectorAll(
                      ".vditor-" + t.currentMode + "__preview[data-render='2']"
                    )
                    .forEach(function (e) {
                      N(e, t);
                    }),
              ...
              (e.prototype.addCaret = function (e, t) {
                ...
                e.ir.element
                  .cloneNode(!0)
                  .querySelectorAll(
                    ".vditor-" + e.currentMode + "__preview[data-render='1']"
                  )
                  .forEach(function (e) {
                    e.firstElementChild &&
            ...
            return (
              (e.prototype.merge = function () {
                ...
                this.options &&
                  ...
                  (null === (n = this.options.hint) || void 0 === n
                    ? void 0
                    : n.emoji) &&
              ...
              (e.prototype.copy = function (e, t) {
                ...
                if ("" !== n.toString()) {
                  ...
                  d.appendChild(n.cloneContents()),
                    e.clipboardData.setData(
                      "text/plain",
                      t.lute.VditorDOM2Md(d.innerHTML).trim()
                    ),
                    e.clipboardData.setData("text/html", "");
                }
              }),
                ...
                this.unbindListener(),
                  ...
                  this.element.addEventListener("input", function (n) {
                    if (
                      ...
                      if (t.preventInput)
                        return (t.preventInput = !1), void Y(e);
                      if (
                        t.composingLock ||
                        "‘" === n.data ||
                        "“" === n.data ||
                        ...
                        if (
                          (i || (ee(e, r), (i = (0, y.F9)(r.startContainer))),
                          i)
                        ) {
                          for (
                          ...
                          c && "" === c.textContent && (O(e), c.remove()),
                            ...
                            d ||
                            st(i.innerHTML) ||
                            (lt(i.innerHTML) && i.previousElementSibling)
                              ? "function" == typeof e.options.input &&
                                e.options.input(a(e))
                              : ze(e, r, n);
                        }
                        ...
                        n.y > a.top + a.height &&
                          ...
                          "" ===
                            t.element.lastElementChild.textContent
                              .trim()
                              .replace(i.g.ZWSP, "")
                            ? (o.selectNodeContents(t.element.lastElementChild),
                              o.collapse(!1))
                            : (t.element.insertAdjacentHTML(
                                "beforeend",
                                '<p data-block="0">' + i.g.ZWSP + "<wbr></p>"
          ...
          function t(t, n) {
            ...
            if (o.i18n) (window.VditorI18n = o.i18n), r.init(t, o);
              ...
              document
                ...
                (0, l.G)(o.cdn + "/dist/js/i18n/" + o.lang + ".js", s).then(
                  function () {
                    r.init(t, o);
                  }
                );
            ...
            (t.prototype.setTheme = function (e, t, n, r) {
              (this.vditor.options.theme = e),
                ...
                t &&
                  ...
                  (0, U.Z)(t, r || this.vditor.options.preview.theme.path)),
                n &&
                  ((this.vditor.options.preview.hljs.style = n),
                  (0, Zt.Y)(n, this.vditor.options.cdn));
            }),
            ...
            (t.prototype.init = function (e, t) {
              ...
              (this.vditor = {
                ...
                (t.upload.url || t.upload.handler) &&
                  (this.vditor.upload = new Ue()),
                (0, l.G)(
                  t._lutePath || t.cdn + "/dist/js/lute/lute.min.js",
                  "vditorLuteScript"
                ).then(function () {
